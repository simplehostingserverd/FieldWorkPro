...
export const registerUser = async (userData: CreateUser) => {
  try {
    ...
    const result = await query(
      'INSERT INTO users (first_name, last_name, email, phone, role, password_hash, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW()) RETURNING id, first_name, last_name, email, role',
      [
        userData.firstName,
        userData.lastName,
        userData.email,
