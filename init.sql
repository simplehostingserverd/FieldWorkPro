...
((SELECT id FROM organizations WHERE name = 'Acme Field Services'), 'John', 'Admin', 'admin@acmefieldservices.com', '555-1234', 'admin', '$2b$10$example_hash'),
((SELECT id FROM organizations WHERE name = 'Acme Field Services'), 'Jane', 'Manager', 'manager@acmefieldservices.com', '555-5678', 'manager', '$2b$10$example_hash'),
((SELECT id FROM organizations WHERE name = 'Acme Field Services'), 'Bob', 'Technician', 'tech@acmefieldservices.com', '555-9012', 'technician', '$2b$10$example_hash');
